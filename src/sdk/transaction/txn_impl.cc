...
Status TxnImpl::PreCommit1PC() {
  // 1pc
  DINGO_LOG(DEBUG) << fmt::format("[sdk.txn.{}] precommit use 1pc optimization.", ID());
...
void TxnImpl::Cleanup() {
  CHECK(txn_manager_ != nullptr) << "txn_manager_ should not nullptr.";
